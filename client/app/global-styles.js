...
injectGlobal`
  ...
  *:first-child + html .group {
  ...
  #side-nav {
    ...
    background: #00b4cb;
    /* Old browsers */
    background: -moz-linear-gradient(-45deg, #213683 0%, #213683 100%);
    /* FF3.6-15 */
    background: -webkit-linear-gradient(-45deg, #213683 0%, #213683 100%);
    /* Chrome10-25,Safari5.1-6 */
    background: linear-gradient(135deg, #213683 0%, #213683 100%);
    /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
    filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#00b4cb', endColorstr='#213683',GradientType=1 );
    /* IE6-9 fallback */ }
